...
const ProfileScreen = ({ navigation }) => {
  ...
  const modalForm = (
    <View style={{ alignItems: "center" }}>
          ...
          <Input type="text" placeholder={auth?.currentUser?.displayName} autoFocus autoCapitalize="none" leftIcon={<Icon name="user" type="font-awesome" size={30} color="#D50000" />} />
          <Input style={styles.input} type="email" autoCapitalize="none" placeholder="Email" autoFocus value={newEmail} onSubmitForm={(text) => setNewEmail(text)} leftIcon={<Icon name="at" type="font-awesome" size={30} color="#D50000" />} />

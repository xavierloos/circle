    ...
    <View style={styles.container}>
      ...
      <ModalPoup visible={visible}>
        <View style={{ alignItems: "center" }}>
          ...
          <Input style={styles.input} type="email" placeholder="Password" autoFocus leftIcon={<Icon name="lock" type="font-awesome" size={30} color="#D50000" />} />
          <Input style={styles.input} type="email" placeholder="New Password" autoFocus leftIcon={<Icon name="star" type="font-awesome" size={30} color="#D50000" />} />
        </View>
      </ModalPoup>

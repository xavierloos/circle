    ...
    <View style={styles.container}>
      ...
      <ModalPoup visible={visible}>
        <View style={{ alignItems: "center" }}>
          ...
          <Input secureTextEntry style={styles.input} type="email" placeholder="New Password" autoCapitalize="none" leftIcon={<Icon name="star" type="font-awesome" size={30} color="#D50000" />} />
        </View>
      </ModalPoup>
